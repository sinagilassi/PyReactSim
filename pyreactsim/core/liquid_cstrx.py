...
class LiquidCSTRReactorX(LiquidCSTRReactor):
    """
    Scaled liquid-phase CSTR dynamic reactor model.

    Physical balances are inherited from LiquidCSTRReactor; only solver state
