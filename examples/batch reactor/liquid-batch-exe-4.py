...
from examples.rates.rate_liquid_ABCDE import reaction_rates, components
# ! plot function
...
initial_mole = {
    ...
    "B-l": CustomProp(value=900.0, unit="mol"),
    "C-l": CustomProp(value=150.0, unit="mol"),
    "D-l": CustomProp(value=20.0, unit="mol"),
    "E-l": CustomProp(value=0.0, unit="mol"),
}
