...
from examples.rates.rate_liquid_A_to_B import reaction_rates, components
...
feed_mole_flow = {
    ...
    "B-l": CustomProp(value=0, unit="mol/s"),
}
...
_reactor: PBRReactor = create_pbr_reactor(
    ...
    rhs_log_interval=10,
    rhs_log_enabled=False,
    rhs_log_timing_enabled=False,
)
